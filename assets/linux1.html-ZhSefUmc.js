import{_ as e}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as n,c as s,f as i}from"./app-bC6SZWdu.js";const a="/assets/image-20220521172346658-_pyECa-O.png",l="/assets/image-20220805144032393-VIZalW45.png",d="/assets/image-20220805143917477-uiZu0FKK.png",t="/assets/image-20220805144329900-aKHkmoo9.png",r={},c=i(`<h1 id="日常使用命令" tabindex="-1"><a class="header-anchor" href="#日常使用命令" aria-hidden="true">#</a> 日常使用命令</h1><h2 id="find命令" tabindex="-1"><a class="header-anchor" href="#find命令" aria-hidden="true">#</a> <code>find</code>命令</h2><p>用法：find [路径] [表达式选项] [行动]</p><p><strong>语法</strong></p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>find   path   -option   [   -print ]   [ -exec   -ok   command ]   {} \\;
